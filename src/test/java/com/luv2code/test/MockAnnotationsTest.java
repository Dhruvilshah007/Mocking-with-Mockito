...
//    @InjectMocks
    //It only will inject dependencies annotated with @Mock or @Spy
//    private ApplicationService applicationService;
//


    //Using Spring Boot mockbean,this is prefereed approach

    //It helps for mocking and also adds bean to Application context
    @MockBean
    private ApplicationDao applicationDao;
    @Autowired
    private ApplicationService applicationService;
    ...
    public void assertEqualsTestAddGrades() {
        ...
        //Mokcing and telling what response dao should send when addGradeResultsForSingleClass method is called
        ...
        //It verifies that DAO method is called
        verify(applicationDao).addGradeResultsForSingleClass(studentGrades.getMathGradeResults());

        //How many times method is called, during the given test
    ...
    public void throwRuntimeError() {
        ...
        //Here we are getting object from context which will be null
    ...
    public void stubbingConsecutiveCalls() {
        ...
        //For the first call throw an exception and later return a String
